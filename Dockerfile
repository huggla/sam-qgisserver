...
ARG BUILDDEPS="build-base cmake gdal-dev geos-dev libzip-dev \
               ...
               acct cmake cryptsetup-libs device-mapper-libs syslinux mtools lddtree openrc ncurses-terminfo openssh alpine-conf busybox-suid busybox-initscripts alpine-keys alpine-base libcap qt5-qtbase-x11 openssl libcom_err libattr chrony chrony-openrc e2fsprogs e2fsprogs-libs"
