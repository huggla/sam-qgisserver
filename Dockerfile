...
ARG RUNDEPS="spawn-fcgi fcgi qt5-qtbase qt5-qtbase-x11 opencl-icd-loader qt5-qtsvg qt5-qtwebkit libqca qt5-qtkeychain gdal libspatialite libzip qt5-qtserialport qt5-qtlocation libev openmpi libstdc++ exiv2"
ARG BUILDDEPS="build-base cmake gdal-dev geos geos-dev libzip-dev \
