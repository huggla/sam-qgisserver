...
ARG BUILDDEPS="build-base cmake binutils protobuf-c protobuf-c-dev protobuf protobuf-dev binutils-gold cmake-extras extra-cmake-modules cmake-bash-completion scanelf gdal-dev geos geos-dev libzip-dev \
