...
ARG BUILDDEPS="build-base cmake binutils protobuf-c py3-protobuf protobuf-c-dev protobuf protobuf-dev binutils-gold cmake-extras extra-cmake-modules cmake-bash-completion scanelf gdal-dev geos geos-dev libzip-dev \
               ...
               py3-sip-pyqt5 py3-sip py-sip-dev qt5-qttools-static musl-nscd musl-nscd-dev musl musl-obstack musl-obstack-dev musl-locales-lang musl-locales mesa-gl \
               qt5-qtxmlpatterns-dev py3-opencl fortify-headers boost-dev boost-build libev-dev qt5-qtwebengine-dev qt5-qtwebview-dev musl-dev musl-utils musl-dbg musl-libintl"
...
"&& cmake -GNinja -DCMAKE_INSTALL_PREFIX=/usr -DWITH_GRASS=OFF -DWITH_GRASS7=OFF \
          ...
          -DSERVER_SKIP_ECW=ON -DWITH_GEOREFERENCER=OFF -DCMAKE_C_FLAGS=\"$CFLAGS\" -DPROJ_LIBRARY=/usr/lib/libproj.so.20 -DPOSTGRES_LIBRARY=/usr/lib/libpq.so.5 -DSQLITE3_LIBRARY=/usr/lib/libsqlite3.so.0 \
