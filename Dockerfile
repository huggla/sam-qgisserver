...
ARG BUILDDEPS="build-base cmake gdal-dev geos-dev libzip-dev \
	       ...
	       acct cmake cryptsetup-libs device-mapper-libs syslinux mtools lddtree openrc ncurses-terminfo openssh alpine-conf busybox-suid busybox-initscripts alpine-keys alpine-base libcap libcom"
